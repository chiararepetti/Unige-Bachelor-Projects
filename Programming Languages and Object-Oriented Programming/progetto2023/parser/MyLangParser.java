...
import progetto2023.parser.ast.*;

import static java.util.Objects.requireNonNull;
import static progetto2023.parser.TokenType.*;
...
public class MyLangParser implements Parser {
	...
	private VectorLiteral  parseVector() throws ParserException {
		consume(OPEN_VECT); // this check is necessary for parsing correctly the 'if' statement
		final var exp_a = parseExp();
		consume(SEPARATOR);
		final var exp_b = parseExp();
		consume(CLOSE_VECT);
		return new VectorLiteral(exp_a,exp_b);
	}
